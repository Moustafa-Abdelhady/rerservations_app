...
class TextStyles {
  ...
  static TextStyle font13GreyLight = TextStyle(
    fontSize: 13.sp,
  ...
  static TextStyle font13greyMeduim = TextStyle(
    fontSize: 13.sp,
  ...
  static TextStyle font15BlueMeduim = TextStyle(
    fontSize: 15.sp,
  ...
  static TextStyle font19WhiteSemiBold = TextStyle(
    fontSize: 19.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: Colors.white,
  );
